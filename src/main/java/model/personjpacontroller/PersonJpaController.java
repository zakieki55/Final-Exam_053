 ...
 */
package model.personjpacontroller;
...
import model.personjpacontroller.exceptions.NonexistentEntityException;
import model.personjpacontroller.exceptions.PreexistingEntityException;
...
public class PersonJpaController implements Serializable {
    ...
    private EntityManagerFactory emf = Persistence.createEntityManagerFactory("b.finalexam_finalexam_jar_0.0.1-SNAPSHOTPU");
